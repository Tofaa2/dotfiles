...
sudo pacman -Sy hyprshot sxiv hyprpaper cliphist xdg-desktop-portal-hyprland zsh waybar pavucontrol swaync bashrc starship ghostty neovim firefox fastfetch
